# real_mobile_bomber.py (PASTE THIS EXACT CODE)
            ...
            for msg in messages:
                ...
                try:
                    ...
                    if r1.status_code != 200 or 'login' in r1.url.lower():
                        add_log("BLOCKED or GC ID wrong!")
                        return
                    ...
                    if not dtsg:
                        add_log("fb_dtsg NOT FOUND! Try again.")
                        continue
                    ...
                    if r2.status_code == 200 and 'error' not in r2.text.lower():
                        ...
                        add_log(f"FAILED → Rate limit or block")
...
def index():
    if request.method == 'POST':
        try:
            ...
            add_log("BOMBING LIVE! NEW COOKIE ALIVE!")
    ...
    return '''
    <!DOCTYPE html>
    <html><head><meta charset="utf-8"><title>REAL BOMBER</title>
...
if __name__ == '__main__':
    print("REAL BOMBER → http://localhost:5000")
